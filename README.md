...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-pathdiagram-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8585&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-pathdiagram-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-pathdiagram` can be installed with:

```
conda install r-pathdiagram
```

It is possible to list all of the versions of `r-pathdiagram` available on your platform with:
